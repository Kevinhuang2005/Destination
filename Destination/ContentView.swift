...
struct ContentView: View {
    ...
    let destinations = ["Paris", "New York", "Nanjing", "Tokyo", "Rochester"]
    ...
    private func pickDestination() {
        if(destinations[selection]) == "Nanjing"{
            destinationStr = "Congratulations - your trip to \(destinations[selection]) has been confirmed! Welcome to my hometown!"
        }else{
